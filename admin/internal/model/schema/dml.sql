...
INSERT INTO deepkg_db.document (created_at,updated_at,deleted_at,doc_name,doc_desc,doc_path,dir_id,creator_id)
VALUES ('2025-06-13 13:59:55.498','2025-06-13 13:59:55.498',NULL,'data.txt','test','http://127.0.0.1:9003/file/ed4c9cac700f14d4a191f69fee9c8136.txt',1,1);

INSERT INTO deepkg_db.document_dir (created_at,updated_at,deleted_at,dir_name,parent_id,sort_index,remark)
VALUES ('2025-06-13 13:42:17.524','2025-06-13 13:42:17.524',NULL,'测试',0,0,'测试创建文件夹');

INSERT INTO deepkg_db.knowledge_graph_workspace (id, Created_at, updated_at, deleted_at, work_space_name, creator_id)
VALUES (1,'2025-06-13 14:24:50.491', '2025-06-13 14:24:50.491', NULL, '测试工作空间', 1);

INSERT INTO deepkg_db.extract_task (id,created_at,updated_at,deleted_at,task_name,remark,work_space_id,task_status,published,creator_id)
VALUES
...
INSERT INTO deepkg_db.extract_task_document (created_at,updated_at,deleted_at,task_id,doc_id)
VALUES ('2025-06-13 14:54:28.572','2025-06-13 14:54:28.572',NULL,1,1),
       ('2025-06-13 15:51:16.250','2025-06-13 15:51:16.250',NULL,2,1);

INSERT INTO deepkg_db.extract_task_triple (created_at,updated_at,deleted_at,task_id,triple_id)
VALUES
...
INSERT INTO deepkg_db.schema_ontology (created_at,updated_at,deleted_at,work_space_id,ontology_name,ontology_desc,creator_id)
VALUES
...
INSERT INTO deepkg_db.schema_ontology_prop (created_at,updated_at,deleted_at,work_space_id,ontology_id,prop_name,prop_desc,creator_id)
VALUES
    ('2025-06-13 15:43:06.551','2025-06-13 15:43:06.551',NULL,1,3,'公司邮箱','公司邮箱',1);
INSERT INTO deepkg_db.schema_triple (created_at,updated_at,deleted_at,work_space_id,source_ontology_id,target_ontology_id,relationship,creator_id)
VALUES
