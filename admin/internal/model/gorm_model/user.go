...
type User struct {
	...
	CreatedAt    time.Time
	UpdatedAt    time.Time
	DeletedAt    soft_delete.DeletedAt `gorm:"uniqueIndex:udx_account;"`
	...
	Account      string                `gorm:"column:account; type:varchar(255); not null; comment:账号用于登录; uniqueIndex:udx_account;" json:"account"`
